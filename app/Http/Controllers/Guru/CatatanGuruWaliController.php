...
class CatatanGuruWaliController extends Controller
{
    ...
    public function index($siswa_id)
    {
        ...
        $catatanList = CatatanGuruWali::where('siswa_id', $siswa_id)
            ->where('guru_nama', $guru->nama)
            ->orderBy('tanggal_pencatatan', 'desc')
            ->get();

        return view('guru.catatan-guru-wali.index', compact(
            'siswa',
            'catatanList',
            'rombel',
            'periodeAktif'
    ...
    public function create($siswa_id)
    {
        ...
        return view('guru.catatan-guru-wali.form', [
            'siswa' => $siswa,
            'rombel' => $rombel,
    ...
    public function store(Request $request, $siswa_id)
    {
        ...
        return redirect()
            ->route('guru.catatan-guru-wali.index', $siswa_id)
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('guru.catatan-guru-wali.index', $catatan->siswa_id)
