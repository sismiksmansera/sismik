...
@section('content')
@php
    use App\Http\Controllers\Admin\AnggotaEkstrakurikulerController;
...
<div class="main-content anggota-ekstra-page">
    ...
    <div class="action-buttons-center">
        <a href="{{ route('admin.ekstrakurikuler.index') }}" class="btn-back">
    ...
    <div class="members-container">
        ...
        <div class="members-cards-grid">
            ...
            @php
                ...
                $gender_gradient = ($anggota->jk == 'Laki-laki' || $anggota->jk == 'L') ? 'linear-gradient(135deg, #3b82f6, #1d4ed8)' : 'linear-gradient(135deg, #ec4899, #db2777)';
                ...
                <div class="member-card-body" id="{{ $cardId }}">
                    <div class="member-details-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                @if($anggota->jk == 'Laki-laki' || $anggota->jk == 'L')
                    ...
                    <div class="member-actions-row">
                        ...
                        <div class="action-buttons-card">
                            ...
                            <form method="POST" action="{{ route('admin.ekstrakurikuler.anggota.hapus', $ekstra->id) }}" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus anggota ini?')">
                                @csrf
...
<div id="modalTambah" class="modal">
    <div class="modal-content">
        ...
        <form method="POST" action="{{ route('admin.ekstrakurikuler.anggota.tambah', $ekstra->id) }}" id="formTambah">
            @csrf
...
function saveSingleNilai(anggotaId) {
    ...
    fetch('{{ route("admin.ekstrakurikuler.anggota.update-nilai", $ekstra->id) }}', {
        method: 'POST',
        headers: {
