...
@media print {
    ...
    .persen-badge { padding: 0px 2px !important; border-radius: 1px; font-size: 8px !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; line-height: 1 !important; }
    ...
    <div class="main-content">
        <div class="cek-presensi-page">
            ...
            <div class="page-header-center">
                ...
                <h1>Cek Presensi Siswa</h1>
                <div class="header-periode-badge"><i class="fas fa-calendar-alt"></i> {{ $tahunPelajaran }} - Semester {{ ucfirst($semesterAktif) }}</div>
            </div>
                ...
                <div class="jp-table-wrapper">
                    <table class="jp-table">
                        <colgroup>
                            ...
                            <col class="col-nisn">
                            <col class="col-nama">
                            <col class="col-jp"><col class="col-jp"><col class="col-jp"><col class="col-jp"><col class="col-jp">
                            <col class="col-jp"><col class="col-jp"><col class="col-jp"><col class="col-jp"><col class="col-jp">
            ...
            if (data.success && data.data.length > 0) {
                ...
                let html = `
                    ...
                    <table class="detail-table">
                        <thead><tr>
                            <th style="text-align:center">No</th><th>Nama / NISN</th><th style="text-align:center">Status</th>${canEdit ? '<th style="text-align:center">Aksi</th>' : ''}
                        </tr></thead><tbody>`;
                ...
                data.data.forEach((s, i) => {
                    html += `<tr>
                        ...
                        <td style="text-align:center"><span class="presensi-status ${s.presensi}">${s.presensi}</span></td>
