...
<div class="layout">
    ...
    <div class="main-content">
        ...
        <!-- Form -->
        <form action="{{ route('admin.ekstrakurikuler.update', $ekstra->id) }}" method="POST" class="ekstra-form" id="ekstraForm">
            @csrf
            @method('PUT')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadAnggotaTerdaftar() {
        fetch('{{ route("admin.ekstrakurikuler.get-siswa-by-ids") }}?ids=' + selectedSiswa.join(','))
            .then(res => res.json())
            .then(data => {
