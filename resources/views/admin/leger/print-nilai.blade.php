...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        thead th { background: linear-gradient(180deg, #3b82f6 0%, #1d4ed8 100%); color: white; }
        ...
        .rata-rata-col { background: #eff6ff !important; font-weight: 700; color: #1d4ed8; }
...
<body>
    <div class="container">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th colspan="{{ count($mapelList) }}" style="background: #10b981;">Mata Pelajaran</th>
                        <th rowspan="2" style="width: 35px; background: #f59e0b;">Jumlah</th>
                        <th rowspan="2" style="width: 35px; background: #8b5cf6;">Rata²</th>
                        <th rowspan="2" style="width: 35px; background: #10b981;">Hadir</th>
                        <th rowspan="2" style="width: 30px; background: #ef4444;">Rank</th>
                    </tr>
                    <tr>
                        @foreach($mapelList as $mapel)
                        <th style="writing-mode: vertical-rl; text-orientation: mixed; height: 90px; min-width: 20px; font-size: 6pt; background: #059669; padding: 3px 2px;">
                            {{ $mapel->nama_mapel }}
                        </th>
                        @endforeach
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @foreach($mapelList as $mapel)
                        @php
                            $nilai = $data['nilai_mapel'][$mapel->id] ?? null;
                            $class = '';
                            if ($nilai !== null) {
                        ...
                        @endphp
                        <td class="{{ $class }}">{{ $nilai !== null ? $nilai : '-' }}</td>
                        @endforeach
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
            ...
            <div style="font-size: 7pt;">
                <p style="margin: 0; font-weight: 600;">Kriteria Ranking (urutan prioritas):</p>
                <p style="margin: 2px 0;">1. Nilai rata-rata tertinggi</p>
                <p style="margin: 2px 0;">2. Persentase kehadiran tertinggi</p>
                <p style="margin: 2px 0;">3. Jumlah setengah nilai tertinggi</p>
            </div>
