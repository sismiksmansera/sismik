...
<head>
    ...
    <style>
        @media print {
            ...
            @page { size: 215.9mm 330.2mm; margin: 10mm 15mm 5mm 15mm; }
        }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-text { flex: 1; text-align: center; padding: 0 10px; line-height: 1.0; }
        ...
        .letter-border { border-bottom: 1px solid #000; margin-bottom: 12px; }

        /* Letter Number */
        .letter-number { display: flex; justify-content: space-between; margin-bottom: 10px; }
        .letter-number-left { width: 55%; }
        .letter-number-left table td { padding: 1px 0; vertical-align: top; font-size: 11pt; }
        .letter-number-left table td:first-child { width: 70px; }

        /* Letter Body */
        .letter-body { text-align: justify; margin-bottom: 8px; }
        .letter-body p { margin-bottom: 6px; text-indent: 30px; }

        /* Student Info */
        .student-info { margin: 8px 0 8px 30px; }
        .student-info table td { padding: 1px 0; vertical-align: top; }
        .student-info table td:first-child { width: 100px; }

        /* Meeting Info */
        .meeting-info { margin: 8px 0 8px 30px; }
        .meeting-info table td { padding: 1px 0; vertical-align: top; }
        .meeting-info table td:first-child { width: 100px; }

        /* Letter Closing */
        .letter-closing { text-align: justify; }
        .letter-closing p { margin-bottom: 6px; text-indent: 30px; }

        /* Signature Section */
        .signature-section { margin-top: 15px; display: flex; justify-content: space-between; }
        .signature-left, .signature-right { width: 48%; text-align: center; }
        .signature-left .title, .signature-right .title { margin-bottom: 45px; }
        .signature-left .name, .signature-right .name { font-weight: bold; text-decoration: underline; }
        .signature-left .nip, .signature-right .nip { font-size: 10pt; }

        /* Tear Line */
        .tear-line { margin: 15px 0 10px 0; text-align: center; position: relative; }
        .tear-line::before { content: ''; position: absolute; left: 0; right: 0; top: 50%; border-top: 1px dashed #000; }
        .tear-line span { background: white; padding: 0 10px; position: relative; font-size: 9pt; }

        /* Receipt Section */
        .receipt-section { background: #f9f9f9; padding: 10px; border: 1px solid #ddd; border-radius: 5px; }
        .receipt-section h4 { text-align: center; margin-bottom: 8px; font-size: 10pt; }
        .receipt-info table { width: 100%; }
        .receipt-info table td { padding: 1px 0; font-size: 10pt; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="letter-number">
            ...
            <div style="text-align: right; font-size: 11pt;">Seputih Raman, {{ $tanggalSurat }}</div>
        </div>
        ...
        <div class="letter-body">
            <p>Dengan hormat,</p>
            <p>Melalui surat ini, kami dari pihak sekolah SMA Negeri 1 Seputih Raman bermaksud mengundang Bapak/Ibu
                untuk hadir ke sekolah guna membahas perkembangan dan kondisi putra/putri Bapak/Ibu:</p>
            ...
            <div class="meeting-info">
                <table>
                    <tr>
                        <td>Hari/Tanggal</td>
                        <td>: {{ $hariPanggilan }}, {{ $tanggalPanggilan }}</td>
                    </tr>
                    <tr>
                        <td>Pukul</td>
                        <td>: {{ $jamPanggilan }} - Selesai</td>
                    </tr>
                    <tr>
                        <td>Tempat</td>
                    ...
                    <tr>
                        <td>Menghadap</td>
                        <td>: {{ $panggilan->menghadap_ke ?? $panggilan->nama_guru_bk ?? 'Guru BK' }}</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="signature-section">
            <div class="signature-left">
                <p>Mengetahui,</p>
                <p>Kepala SMA Negeri 1 Seputih Raman</p>
                <p class="title"></p>
            ...
            <div class="signature-right">
                ...
                <p class="title"></p>
                <p class="name">{{ $panggilan->nama_guru_bk ?? '-' }}</p>
                <p class="nip">NIP. {{ $panggilan->nip_guru_bk ?? '-' }}</p>
            </div>
        </div>
