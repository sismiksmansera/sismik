    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    @foreach($ekstraList as $index => $ekstra)
                    <tr>
                        <td class="text-center">{{ $index + 1 }}</td>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 9pt;">{{ Str::limit($catatan->masalah, 80) }}</td>
                        <td class="text-center">
                            <span class="badge" style="{{ $catatan->status == 'Selesai' ? 'background: #dcfce7; color: #15803d;' : 'background: #fef3c7; color: #a16207;' }}">
                                {{ $catatan->status }}
                            </span>
                        </td>
                    </tr>
