...
@section('content')
<div class="main-content create-catatan-page">
    <div class="content">
        {{-- PROFILE CONTAINER --}}
        <div class="profile-container">
            ...
            <div class="profile-sidebar">
                ...
                <div class="info-card">
                    ...
                    <div class="info-item">
                        <label>Rombel (Semester {{ $semester_aktif_siswa ?? '-' }})</label>
                ...
                <div class="info-card">
                    <h4 class="info-title">
                        <i class="fas fa-history"></i> Riwayat Akun
                    </h4>
                    ...
                    <div class="history-item">
                        ...
                        <div>
                            <div class="history-label">Didaftarkan</div>
                            <div class="history-value">{{ \Carbon\Carbon::parse($siswa->created_at)->format('d M Y') }}</div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="history-item">
                        ...
                        <div>
                            <div class="history-label">Terakhir Update</div>
                            <div class="history-value">{{ \Carbon\Carbon::parse($siswa->updated_at)->format('d M Y') }}</div>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="profile-form">
                ...
                <div class="form-card">
                    <div class="form-header">
                        <h3><i class="fas fa-plus-circle"></i> Input Catatan Bimbingan Baru</h3>
                    </div>

                    <form method="POST" action="{{ route('guru_bk.catatan-bimbingan.store', $nisn) }}" class="catatan-form">
                        @csrf
                                ...
                                <div class="form-column">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="jenis_bimbingan" name="jenis_bimbingan" class="form-control" required>
                                            ...
                                            <option value="Belajar" {{ old('jenis_bimbingan') == 'Belajar' ? 'selected' : '' }}>Belajar</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="status" name="status" class="form-control" required>
                                            ...
                                            <option value="Belum Ditangani" {{ old('status') == 'Belum Ditangani' ? 'selected' : '' }}>Belum Ditangani</option>
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    <textarea id="penyelesaian"
                                            ...
                                            required>{{ old('penyelesaian') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    <textarea id="keterangan"
                                            ...
                                            class="form-control" 
                                            rows="3" 
                                            placeholder="Tambahan keterangan lainnya (opsional)...">{{ old('keterangan') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                ...
                                <div class="action-right">
                                    ...
                                    <button type="submit" class="btn-submit">
                                        <i class="fas fa-save"></i> <span class="btn-text">Simpan Catatan</span>
                                    </button>
                                </div>
                            </div>
                        </div>
...
<style>
/* Mobile Back Header - Only visible on mobile */
.mobile-back-header {
    display: none;
}
...
/* Inherit styles from edit-catatan - identical styling */
.main-content.create-catatan-page {
    background: #f9fafb;
