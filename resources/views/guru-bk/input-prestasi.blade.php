        ...
        <div class="page-wrapper">
            ...
            <div class="page-header">
                <div class="header-row">
                    <a href="{{ url('guru-bk/prestasi?type=' . $type . '&id=' . $sourceId) }}" class="btn-back">
            ...
            <div class="form-card">
                ...
                <form id="formPrestasi" class="form-body">
                    ...
                    <div class="form-actions">
                        <a href="{{ url('guru-bk/prestasi?type=' . $type . '&id=' . $sourceId) }}" class="btn-cancel">
...
document.getElementById('formPrestasi').addEventListener('submit', function(e) {
    ...
    fetch('{{ url("guru-bk/prestasi/store") }}', {
        method: 'POST',
    ...
    .then(data => {
        if (data.success) {
            ...
            setTimeout(() => {
                window.location.href = '{{ url("guru-bk/prestasi") }}?type={{ $type }}&id={{ $sourceId }}';
            }, 1500);
        } else {
