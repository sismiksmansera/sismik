    ...
    <div class="main-content">
        ...
        <div class="content-header">
            ...
            <div class="header-actions">
                <a href="{{ route('guru_bk.koordinator-ekstra.create') }}" class="btn btn-primary" style="background: white; color: #3b82f6;">
        ...
        <div class="content-section">
            ...
            @else
                <div class="empty-state">
                    ...
                    <a href="{{ route('guru_bk.koordinator-ekstra.create') }}" class="btn btn-primary">
