    ...
    <div class="main-content">
        <div class="form-page">
            ...
            <div class="form-card">
                ...
                <form action="{{ $catatan 
                    ? route('guru.catatan-guru-wali.update', $catatan->id) 
                    : route('guru.catatan-guru-wali.store', $siswa->id) }}" method="POST">
                    @csrf
                    @if($catatan)
                        @method('PUT')
                    @endif
                    ...
                    <div class="form-actions">
                        <a href="{{ route('guru.catatan-guru-wali.index', $siswa->id) }}" class="btn-modern btn-cancel">
