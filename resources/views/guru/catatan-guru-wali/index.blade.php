    ...
    <div class="main-content">
        <div class="catatan-page">
            ...
            <div class="action-bar">
                <a href="{{ route('guru.siswa-bimbingan') }}" class="btn-modern btn-back">
                    <i class="fas fa-arrow-left"></i> Kembali
                </a>
                <a href="{{ route('guru.catatan-guru-wali.create', $siswa->id) }}" class="btn-modern btn-primary">
                    ...
                    @foreach($catatanList as $catatan)
                        ...
                        <div class="catatan-card">
                            ...
                            <div class="catatan-actions">
                                <a href="{{ route('guru.catatan-guru-wali.edit', $catatan->id) }}" class="btn-modern btn-sm btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('guru.catatan-guru-wali.destroy', $catatan->id) }}" method="POST" 
