...
<div class="layout">
    ...
    <div class="main-content">
        ...
        <!-- Form -->
        <form action="{{ route('guru.koordinator-ekstra.update', $ekstra->id) }}" method="POST" class="ekstra-form" id="ekstraForm">
            @csrf
            @method('PUT')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadAnggotaTerdaftar() {
        fetch('{{ route("guru.koordinator-ekstra.get-siswa-by-ids") }}?ids=' + selectedSiswa.join(','))
            .then(res => res.json())
            .then(data => {
    ...
    function loadSiswaData() {
        ...
        fetch('{{ route("guru.koordinator-ekstra.get-siswa") }}', {
            method: 'POST',
            body: formData,
            headers: {
