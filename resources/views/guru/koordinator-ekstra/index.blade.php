        ...
        <div class="content-section">
            <div class="section-header">
                ...
                <div class="section-header-right">
                    <a href="{{ route('guru.koordinator-ekstra.export-excel', ['tahun' => $filterTahun, 'semester' => $filterSemester]) }}" class="btn-export-excel"><i class="fas fa-file-excel"></i> Download Excel</a>
                    ...
                    @foreach($ekstrakurikulerList as $ekstra)
                        ...
                        <div class="ekstra-card {{ $isAktif ? 'active' : '' }}">
                            ...
                            <div class="ekstra-info">
                                <div class="info-grid">
                                    <a href="{{ route('guru.anggota-ekstrakurikuler') }}?id={{ $ekstra->id }}" class="info-item">
                                        <div class="info-icon">
                                    ...
                                    <a href="{{ route('guru.lihat-prestasi') }}?type=ekstra&id={{ $ekstra->id }}" class="info-item">
                            ...
                            <div class="ekstra-actions">
                                <a href="{{ route('guru.koordinator-ekstra.edit', $ekstra->id) }}" class="btn-action btn-edit">
...
<script>
    function confirmDelete(id, nama) {
        document.getElementById('deleteForm').action = '{{ url("guru/koordinator-ekstra") }}/' + id;
