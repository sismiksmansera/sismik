...
<style>
    ...
    .info-item i { color: #8b5cf6; margin-right: 10px; width: 20px; text-align: center; }
    ...
    .dropzone:hover { border-color: #8b5cf6; background: #f5f3ff; }
...
<div class="layout">
    ...
    <div class="main-content">
        ...
        @if(session('success'))
            <div style="background: #ede9fe; color: #5b21b6; padding: 12px; border-radius: 6px; margin-bottom: 15px; border: 1px solid #c4b5fd;">
        ...
        <div class="profile-container">
            ...
            <div class="profile-sidebar">
                ...
                <div class="profile-card">
                    @php
                        ...
                        $fotoSize = $hasFoto ? Storage::disk('public')->size('guru_bk/' . $guruBk->foto) : 0;
                ...
                <div class="info-card">
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $guruBk->nip ?: '-' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $guruBk->created_at ? \Carbon\Carbon::parse($guruBk->created_at)->format('d M Y') : '-' }}</div>
                        </div>
                    </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $guruBk->status_kepegawaian ?: '-' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $guruBk->golongan }}</div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $guruBk->jabatan }}</div>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="profile-form">
                <form action="{{ route('guru_bk.profil.update') }}" method="POST" class="form-card">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $guruBk->nama }}" disabled>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $guruBk->nip ?: '-' }}" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $guruBk->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}" disabled>
                            </div>
                        </div>
                    </div>
...
<div id="uploadModal" class="modal-overlay">
    <div class="modal-box">
        ...
        <h3 style="margin-top: 0; color: #5b21b6; margin-bottom: 20px;">
            <i class="fas fa-camera"></i> Upload Foto Profil
        </h3>
        
        <form action="{{ route('guru_bk.profil.upload-foto') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div style="background: #f5f3ff; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="font-weight: 600; margin: 0 0 8px; font-size: 14px; color: #5b21b6;"><i class="fas fa-info-circle"></i> Ketentuan:</p>
            ...
            <div style="display: flex; justify-content: space-between; gap: 12px;">
                ...
                <button type="submit" style="flex: 1; padding: 10px 25px; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600;">
