...
<head>
    ...
    <title>@yield('title', 'SISMIK')</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            /* Reset collapsed styles on mobile when open */
            ...
            .datetime-section #currentDate {
                font-size: 12px !important;
            }
            
            .datetime-section #currentTime {
        ...
        .stat-icon.primary { background: rgba(16, 185, 129, 0.15); color: var(--primary); }
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 1. DESKTOP: Toggle collapsed on header click
            if (sidebarHeader) {
            ...
            // 2. MOBILE: Toggle sidebar visibility
            if (mobileToggle) {
            ...
            // 3. Close sidebar when clicking overlay
            if (overlay) {
