...
<style>
    ...
    .dropzone:hover { border-color: #10b981; background: #ecfdf5; }
...
<div class="layout">
    ...
    <div class="main-content">
        ...
        @if(session('success'))
            <div style="background: #dcfce7; color: #166534; padding: 12px; border-radius: 6px; margin-bottom: 15px; border: 1px solid #86efac;">
        ...
        <div class="profile-container">
            ...
            <div class="profile-sidebar">
                ...
                <div class="profile-card">
                    @php
                        ...
                        $fotoSize = $hasFoto ? Storage::disk('public')->size('siswa/' . $siswa->foto) : 0;
                    ...
                    <div class="profile-avatar" onclick="openFotoModal()">
                        @if($hasFoto)
                            <img src="{{ asset('storage/siswa/' . $siswa->foto) }}" alt="{{ $siswa->nama }}" id="profilePhoto">
                        @else
                    ...
                    <div class="profile-status">
                        <i class="fas fa-circle" style="color: {{ ($siswa->status_siswa ?? 'Aktif') === 'Aktif' ? '#10b981' : '#ef4444' }}; font-size: 10px;"></i>
                ...
                <div class="info-card">
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $siswa->nama_rombel ?: '-' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $siswa->angkatan_masuk ?: '-' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-card">
                    <h4><i class="fas fa-user-friends"></i> Data Orang Tua</h4>
                    
                    <div class="info-item">
                        <i class="fas fa-male"></i>
                        <div>
                            <div class="label">Nama Ayah</div>
                            <div class="value">{{ $siswa->nama_bapak ?: '-' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <div class="value">{{ $siswa->nama_ibu ?: '-' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            <div class="label">HP Ayah</div>
                            <div class="value">{{ $siswa->nohp_bapak }}</div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="info-item">
                        <i class="fas fa-phone"></i>
                        <div>
                            <div class="label">HP Ibu</div>
                            <div class="value">{{ $siswa->nohp_ibu }}</div>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="profile-form">
                <form action="{{ route('siswa.profil.update') }}" method="POST" class="form-card">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label><i class="fas fa-id-badge"></i> NISN</label>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $siswa->jk == 'L' ? 'Laki-laki' : 'Perempuan' }}" disabled>
                            </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label><i class="fas fa-map-marker"></i> Tempat Lahir</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $siswa->tgl_lahir ? \Carbon\Carbon::parse($siswa->tgl_lahir)->format('d M Y') : '-' }}" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" value="{{ old('email', $siswa->email) }}" placeholder="email@siswa.sch.id">
                            </div>
                            
                            <div class="form-group">
                                <label><i class="fas fa-phone"></i> Nomor HP</label>
                                <input type="tel" name="nohp_siswa" class="form-control" value="{{ old('nohp_siswa', $siswa->nohp_siswa) }}" placeholder="0812xxxxxxx">
                            </div>
                        </div>
                    </div>
...
<div id="uploadModal" class="modal-overlay">
    <div class="modal-box">
        ...
        <h3 style="margin-top: 0; color: #047857; margin-bottom: 20px;">
            <i class="fas fa-camera"></i> Upload Foto Profil
        </h3>
        
        <form action="{{ route('siswa.profil.upload-foto') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div style="background: #ecfdf5; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="font-weight: 600; margin: 0 0 8px; font-size: 14px; color: #047857;"><i class="fas fa-info-circle"></i> Ketentuan:</p>
